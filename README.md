<a href="https://codeberg.org/ziedak/dotfiles">
...
[![Commit activity](https://img.shields.io/github/commit-activity/m/ziedak/dotfiles?style=flat)](https://codeberg.org/ziedak/dotfiles/activity/monthly)
[![Latest commit](https://img.shields.io/github/last-commit/ziedak/dotfiles/main?label=Latest%20Commit&style=flat)](https://codeberg.org/ziedak/dotfiles/commits/branch/main)
...
![Full Desktop](https://codeberg.org/ziedak/dotfiles/raw/branch/screenshots/screenshot-full.png)
![Floating Desktop](https://codeberg.org/ziedak/dotfiles/raw/branch/screenshots/screenshot-floating.png)
...
4. Make sure you've got a working network connection and clone the repo with `git clone https://codeberg.org/ziedak/dotfiles /mnt/etc/nixos`.
...
+ **How do I change the default username?**
  ...
  2. Or change `"ziedak"` in modules/options.nix.
...
[host/purple]: https://github.com/ziedak/dotfiles/tree/master/hosts/purple
